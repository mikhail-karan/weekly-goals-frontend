<template>
  <div class="w-full absolute bg-hattBlue flex flex-row items-center justify-between text-white p-2 shadow-md">
    ...
    <div class="flex flex-row text-2xl">
      ...
      <a class="flex items-center mr-3 hover:text-blue-600" href="https://discord.com/invite/jweMCx9"><i class="lab la-discord"></i></a>
      <a class="flex items-center hover:text-blue-600" href="https://twitter.com/htmleverything"><i class="lab la-twitter"></i></a>
    </div>
  </div>
</template>
