    ...
    <section class="flex flex-col items-center h-3/4 md:flex-row">
            <div class="container mx-auto">
                <div class="flex justify-center px-2 py-6 ">
                    <div class="flex w-full rounded-lg bg-cardColor xl:w-3/4 lg:w-11/12 lg:shadow-xl ">
                        <div class="relative hidden w-full h-auto bg-cover border-r rounded-l-lg bg-blue-1300 lg:block lg:w-6/12">
                            <div class="relative z-10 m-12 text-left ">
                                <h2 class="mt-12 mb-2 text-2xl font-semibold tracking-tighter text-purple-400 sm:text-3xl title-font">
                                    Login.
                                </h2>
                                <div
                        ...
                        <div
                            ...
                            <div class="relative z-10 text-left ">
                                ...
                                <form class="mt-6" action="#" method="POST">
                                    <div class="mt-4">
                                        <label class="block text-base font-medium leading-relaxed text-gray-400">Email
                                            Address</label>
                                    ...
                                    <div class="mt-4">
                                        <label class="block text-base font-medium leading-relaxed text-gray-400">Password</label>
                                    ...
                                    <button type="submit" class="block w-full px-4 py-3 mt-6 font-semibold text-white transition duration-500 ease-in-out transform rounded-lg bg-gradient-to-r from-purple-700 hover:from-purple-500 to-purple-500 hover:to-purple-700 focus:shadow-outline focus:outline-none">Log In</button>
                                </form>
                                <p class="mt-8 text-center text-white">Don't have an account? <router-link to="/register"
                                        class="font-semibold text-purple-400 hover:text-purple-700">Register</router-link></p>
                            </div>
                        </div>
                    </div>
                </div>
